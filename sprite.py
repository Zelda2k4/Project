...
pygame.display.set_mode((512,615))                 
screen = pygame.display.get_surface()

sprite = Sprite("spritesheets/hearts.png",0,0,screen,0,0,512,614)
sprite.scale (512*5,614*6)
draw = True
c = pygame.time.Clock()
x_steps = 0
...
while draw:
      for event in pygame.event.get():
        if event.type == pygame.QUIT:
            draw = False
      sprite.x_position -= 512;
      x_steps += 1
      #sprite.y_position -= 512;
      sprite.update()
      screen.fill((0,0,0))
      sprite.draw()
      pygame.display.flip()
